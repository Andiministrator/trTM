...
trTM.f.consent_check = function (action) {
  ...
  if (ci.length == 0) { /* trTM.d.consent.feedback = 'No Services configured in Usercentrics'; trTM.d.consent.hasResponse = true; */ return false; }
  ...
  if (serviceIDs.length>0) trTM.d.consent.serviceIDs = ',' + serviceIDs.join(',') + ',';
  // Build feedback
  ...
  // Get Consent ID
  if (typeof UC_UI.getControllerId=='function') trTM.d.consent.consent_id = UC_UI.getControllerId();
